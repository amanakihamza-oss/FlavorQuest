...
const PrivacyPage = () => {
    return (
        <div className="max-w-3xl mx-auto px-6 py-12">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8">Politique de Confidentialité</h1>

            <div className="prose prose-orange dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 space-y-8">
                <section>
                    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">1. Collecte des données</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">2. Cookies & Stockage Local</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">3. Vos Droits</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">4. Hébergement</h2>
                    <p>
