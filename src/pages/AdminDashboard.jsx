            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-10">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-gray-500 text-sm font-medium">Revendications</p>
                            <p className="text-2xl font-bold text-gray-900">{stats.claimsPending}</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 min-h-[400px] animate-fade-in overflow-hidden">
                <table className="w-full text-left border-collapse">
                    <thead className="bg-gray-50 border-b border-gray-100">
                        <tr>
                            <th className="px-6 py-4 font-bold text-gray-700 w-32">Date</th>
                            <th className="px-6 py-4 font-bold text-gray-700">Restaurant</th>
                            <th className="px-6 py-4 font-bold text-gray-700">Demandeur</th>
                            <th className="px-6 py-4 font-bold text-gray-700 w-1/3">Message / Preuve</th>
                            <th className="px-6 py-4 font-bold text-gray-700 text-right">Actions</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-50">
                        {sortedClaims.length > 0 ? sortedClaims.map((claim) => (
                            <tr key={claim.id} className="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td className="px-6 py-4 text-sm text-gray-600">
                                    ...
                                    <div className="text-xs text-gray-400">{claim.contactEmail}</div>
                                    <div className="text-xs text-gray-400">{claim.contactPhone}</div>
                                </td>
                                <td className="px-6 py-4 text-sm text-gray-600">
                                    <p className="mb-2 italic">"{claim.message}"</p>
                                    <div>
