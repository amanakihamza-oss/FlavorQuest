...
const LegalPage = () => {
    return (
        <div className="max-w-3xl mx-auto px-6 py-12">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8">Mentions Légales</h1>
            ...
            <div className="prose prose-orange dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 space-y-8">
                <section>
                    ...
                    <p>
                        ...
                        Email : <a href="mailto:contact@flavorquest.be" className="text-brand-orange hover:underline text-brand-orange">contact@flavorquest.be</a>
                    </p>
                </section>
                ...
                <section>
                    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">3. Propriété Intellectuelle</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">4. Responsabilité</h2>
                    <p>
